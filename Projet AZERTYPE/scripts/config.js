...
const listeMots = ["Cachalot", "Pétunia", "Serviette", "poudre", "chocolat", "pantalon"]
const listePhrases = ["Pas de panique !", "La vie, l'univers et le reste", "Merci pour le poisson", "la vie est belle!"]